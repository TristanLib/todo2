...
class AppSettings: ObservableObject {
    ...
    @Published var notifyBeforeDueDate: Bool = true {
        didSet { saveSettings() }
    }
    
    @Published var notifyHoursBeforeDueDate: Int = 24 {
        didSet { saveSettings() }
    }
    ...
    private func saveSettings() {
        ...
        do {
            let settings = SettingsData(
                ...
                notifyBeforeDueDate: notifyBeforeDueDate,
                notifyHoursBeforeDueDate: notifyHoursBeforeDueDate,
    ...
    private func loadSettings() {
        ...
        do {
            ...
            self.notifyBeforeDueDate = settings.notifyBeforeDueDate
            self.notifyHoursBeforeDueDate = settings.notifyHoursBeforeDueDate
    ...
    func resetToDefaults() {
        ...
        self.notifyBeforeDueDate = true
        self.notifyHoursBeforeDueDate = 24
...
private struct SettingsData: Codable {
    ...
    let notifyBeforeDueDate: Bool
    let notifyHoursBeforeDueDate: Int
